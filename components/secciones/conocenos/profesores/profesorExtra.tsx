...
export default function ProfesorExtra({
  ...
  return (
    <Drawer>
      <DrawerTrigger className="flex items-center justify-center gap-2 px-2 mt-6 rounded-md bg-bg-300 hover:bg-accent-2">
        saber más
        <FaCirclePlus />
      </DrawerTrigger>
      <DrawerContent>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Esto te redirigirá a tu bandeja de correo para contactarte con
                  este profesor
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
